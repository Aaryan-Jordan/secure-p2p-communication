...
def encrypt_data(data, public_key_pem):
    ...
    return encrypted_key, nonce, tag, encrypted_data

def decrypt_data(encrypted_key, nonce, tag, encrypted_data, private_key):
...
def main():
    ...
    # Encrypt the data
    encrypted_key, nonce, tag, encrypted_data = encrypt_data(data, public_key_pem)
    ...
    # Decrypt the data
    decrypted_data = decrypt_data(encrypted_key, nonce, tag, encrypted_data, private_key)
